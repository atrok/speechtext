...
function GoogleCreate(properties) {
  ...
  if (properties == 'undefined') throw new Error("Properties aren't defined for Google provider");

  var obj = Object.assign(Object.create(proto), properties);

  obj.run = async function google(audiopath, cb) {
    ...
    process.env.GOOGLE_APPLICATION_CREDENTIALS = obj.GOOGLE_APPLICATION_CREDENTIALS;
